...
interface DayCompletionFeedbackModalProps {
  isOpen: boolean;
  completionTime: Date;
...
export const DayCompletionFeedbackModal: React.FC<
  DayCompletionFeedbackModalProps
> = ({
  isOpen,
  completionTime,
  totalPatients,
...
export default DayCompletionFeedbackModal;
